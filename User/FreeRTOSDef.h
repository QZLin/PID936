...
#define TASK_STK_SIZE1 STK_SIZE_BASE
#define TASK_STK_SIZE2 (STK_SIZE_BASE*2)
#define TASK_STK_SIZE3 (STK_SIZE_BASE*3)
#define TASK_STK_SIZE4 (STK_SIZE_BASE*4)
#define TASK_STK_SIZE5 (STK_SIZE_BASE*5)
